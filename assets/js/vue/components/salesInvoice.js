        ...
        <div>
            <div class="row">
                <div class="col-xs-12">
                    ...
                    &nbsp;&nbsp;<label for="w_due"><input type="checkbox" v-model="without_due" value="1" id="w_due"> without Due <label>
                </div>
            </div>
            ...
            <div id="invoiceContent">
                        ...
                        <table _a584de>
                            ...
                            <tbody>
                                <tr v-for="(product, sl) in cart">
                                    ...
                                    <td>{{ product.SaleDetails_Description }}</td>
                                    <td v-if="product.SaleDetails_size_w == 0 && product.SaleDetails_size_h == 0">-</td>
                                    <td v-else>{{ product.SaleDetails_size_w }} x {{ product.SaleDetails_size_h }}</td>
                                    <td v-if="product.SaleDetails_color == 0">-</td>
                                    <td v-else>{{ product.SaleDetails_color }}</td>
                                    <td>{{ sales.SaleMaster_branchid==3?product.Unit_Name=='Plate'?product.SaleDetails_TotalQuantity+"000":product.SaleDetails_TotalQuantity: product.SaleDetails_TotalQuantity}}</td>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <br>
                        <table class="pull-left" v-bind:style="{display: without_due == false ? '' : 'none'}">
                            <tr>
    ...
    async print() {
      ...
      if (this.currentBranch.print_type == "3") {
        ...
        printWindow.document.write(`
                    ...
                    <body>
                        <div class="row">
                            <div class="col-xs-2"><img src="/uploads/company_profile_thum/${this.currentBranch.Company_Logo_org}" alt="Logo" style="height:80px; margin-top:35px;" /></div>
