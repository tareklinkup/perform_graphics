					...
					<tbody>
						<template v-for="sale in sales">
							<tr>
								...
								<td style="text-align:center;" v-if="sale.saleDetails[0].SaleDetails_size_w == 0 && sale.saleDetails[0].SaleDetails_size_h == 0">-</td>
								<td style="text-align:center;" v-else>{{ sale.saleDetails[0].SaleDetails_size_w }} x {{ sale.saleDetails[0].SaleDetails_size_h }}</td>
								<td style="text-align:center;" v-if="sale.saleDetails[0].SaleDetails_color == 0">-</td>
								<td style="text-align:center;" v-else>{{ sale.saleDetails[0].SaleDetails_color }}</td>
							...
							<tr v-for="(product, sl) in sale.saleDetails.slice(1)">
								...
								<td style="text-align:center;" v-if="product.SaleDetails_size_w == 0 && product.SaleDetails_size_h == 0">-</td>
								<td style="text-align:center;" v-else>{{ product.SaleDetails_size_w }} x {{ product.SaleDetails_size_h }}</td>
								<td style="text-align:center;" v-if="product.SaleDetails_color == 0">-</td>
								<td style="text-align:center;" v-else>{{ product.SaleDetails_color }}</td>
