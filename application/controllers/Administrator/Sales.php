        ...
        try {
            ...
            foreach ($data->cart as $cartProduct) {
                $saleDetails = array(
                    ...
                    'SaleDetails_size_w' => $cartProduct->size_w,
                    'SaleDetails_size_h' => $cartProduct->size_h,
                    'SaleDetails_color' => $cartProduct->color,
                    ...
                    'SaleDetails_Description' => $cartProduct->description,
                    'Status' => 'a',
                    'AddBy' => $this->session->userdata("FullName"),
                    'AddTime' => date('Y-m-d H:i:s'),
